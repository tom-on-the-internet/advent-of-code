...
import { turnOnLights, turnOnLightsPartTwo } from "./2015-06.ts"

Deno.test("it turns on the right lights", () => {
    assertEquals(
        turnOnLights([
...
Deno.test("it turns on the right lights part two", () => {
    assertEquals(
        turnOnLightsPartTwo([
...
console.log(turnOnLightsPartTwo(input))
